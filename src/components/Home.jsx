        ...
        >
          ...
          <SwiperSlide>
            <div
              ...
              style={{
                backgroundImage: `url("${bannerPath}carrossel-1.webp")`,
                height: '100%',
                display: 'flex',
                alignItems: 'center',
            ...
            >
              <div className="slide-content" style={{ textAlign: 'center', color: '#fff', zIndex: 10, maxWidth: '800px', padding: '0 20px' }}>
                ...
                <p style={{
                  ...
                  Deixe a Área da Piscina Protegida e com Elegância
                </p>
          ...
          <SwiperSlide>
            <div
              className="slide-item"
              style={{
                backgroundImage: `url("${bannerPath}carrossel-2.webp")`,
                height: '100%',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
            ...
            >
              <div className="slide-content" style={{ textAlign: 'center', color: '#fff', zIndex: 10, maxWidth: '800px', padding: '0 20px' }}>
                ...
                <p style={{ fontSize: '1.2rem', marginBottom: '30px', textShadow: '1px 1px 4px rgba(0,0,0,0.8)' }}>
                  A Cor e o Estilo que Melhor se Adaptam ao Seu Ambiente
                </p>
                <Link to="/products" className="btn-main" style={{
                  background: '#9b1c1c',
                  padding: '12px 35px',
          ...
          <SwiperSlide>
            <div
              className="slide-item"
              style={{
                backgroundImage: `url("${bannerPath}carrossel-3.webp")`,
                height: '100%',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
            ...
            >
              <div className="slide-content" style={{ textAlign: 'center', color: '#fff', zIndex: 10, maxWidth: '800px', padding: '0 20px' }}>
                <h1 style={{
                  ...
                  Os Mais Belos Postes e Luminárias
                </h1>
                <p style={{
                  fontSize: '1.2rem',
                  marginBottom: '30px',
                  ...
                  Ilume o Seu Espaço com o Nosso Estilo
                </p>
                <Link to="/products" className="btn-main" style={{
                  background: '#9b1c1c',
                  padding: '12px 35px',
          ...
          <SwiperSlide>
            <div
              className="slide-item"
              style={{
                backgroundImage: `url("${bannerPath}carrossel-4.webp")`,
                height: '100%',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
